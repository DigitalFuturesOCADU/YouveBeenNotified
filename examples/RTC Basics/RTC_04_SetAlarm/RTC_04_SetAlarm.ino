...
int countDirection = 0;    // 0 = count up to 60, 1 = count down from 60
...
void setup() 
{
  ...
  Serial.println("RTC Minute Counter with Bidirectional Counting and Alarm");
...
void drawAlarm() 
{
  ...
  // Set fill and stroke to "on" (white)
  matrix.fill(0xFFFFFFFF);
  
  
  // Draw a filled rectangle that covers the entire matrix to turn on all LEDs
